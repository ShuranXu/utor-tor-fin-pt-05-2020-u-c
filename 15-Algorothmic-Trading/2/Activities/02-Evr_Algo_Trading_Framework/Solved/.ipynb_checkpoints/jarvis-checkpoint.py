...
def fetch_data():
    ...
    filepath = os.path.join(dir, '../Resources/aapl.csv')
...
def generate_signals(data_df):
    ...
    Adds the SMA50, SMA100 and Signal columns to data_df
    and returns it as signals_df.
    """
...
def execute_backtest(signals_df):
    ...
    Adds Position, Entry/Exit Position, Portfolio Holdings, 
    Portfolio Cash, Portfolio Total, Portfolio Daily Returns
    and Portfolio Cumulative Returns columns to signals_df and returns it"""
    # Set initial capital
