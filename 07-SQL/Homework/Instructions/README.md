# OPTIONAL HOMEWORK - Unit 7 Homework Assignment: Looking for Suspicious Transactions
...
**Section 1 - For the following section, create a nicely formatted README markdown file containing your SQL code and answers for each question.**

*Ensure your SQL is properly formatted. You may either:*
* *Include it in your README markdown file (ensure it is formatted properly)*
* *Upload your SQL files to your homework repo and hyperlink them in your README markdown file*
...
**Section 2 - Answer the questions below in the starter file.**
...
**Section 3 - Answer the questions below in the challenge starter file.**
